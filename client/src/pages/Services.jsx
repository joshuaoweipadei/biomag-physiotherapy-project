  ...
  return (
    <>
      ...
      <div className="service__layout">
        <div className="service_layoutRow">
          <div className="service_layoutCard">
            <h2>The Health Benefit of Biomagnetic energy Pack/Card</h2>
            <ol>
              <li>It generates scalar energy that unclumps and activates living cells</li>
              <li>It increase cellular energy and body energy level for every cell to function normally it requires 70 millivolt of electricity</li>
              <li>Protect your DNA from damages.</li>
              <li>It improves cell wall permeability.</li>
              <li>It is helpful in cancer treatment.</li>
              <li>It reduces inflammation.</li>
              <li>It improves blood circulation.</li>
              <li>Improve immune and endocrine system.</li>
              <li>It has the ability to kill viruses and bacteria.</li>
              <li>It enhances cellular nutrition and detoxification.</li>
              <li>It has zero frequency energy.</li>
              <li>It has a stationary energy which cannot be evaluated by the current frequency instrument.</li>
              ...
              <li>It alkalizes water, foods and vegitables.</li>
              <li>It balance and maintain your body hormones.</li>
              <li>It is made up of negative ions that neutralize the harmful positive ions.</li>
              <li>The scalar energy can pass throght a solid object with no loss of intensity.</li>
              <li>It controls hypertension; reduce excess sugar in the body.</li>
          ...
          <div className="service_layoutCard">
            <h3>How to use this Energy Card</h3>
            <ol>
